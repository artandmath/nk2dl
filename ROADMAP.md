...
- [X] Basic Nuke panel implementation
...
- [X] De-couple CLI code
- [X] De-couple GUI
- [ ] De-couple from Deadline, in a way that the same GUI can be used for any farm backend (Tractor, OpenCue, Qube etc)
