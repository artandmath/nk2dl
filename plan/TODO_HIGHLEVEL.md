...
## Phase 2.1 Expand core features
- [ ] Match thinkbox feature parity
  - [ ] ScriptJob Functionality
- [ ] Create an option where deadline command can batch submit with one deadline command (or one command per render order)
- [ ] Add config options to submit_as_build_job functionality
  - [ ] Option to build with nuke or python (implement pythom at later date?)
  - [X] Option to specify where to save .py: relative or absolute
  - [X] Option to delete or keep the build job python script
- [ ] Fetch settings from metadata  
